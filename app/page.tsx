      ...
      <section className="flex flex-col justify-between gap-6 sm:gap-10 md:gap-16 lg:flex-row">
        <div className="flex flex-col justify-between xl:w-5/12">
          ...
          <div className="sm:text-center lg:py-12 lg:text-left xl:py-24">
            <span className="text-md mb-8 inline-block rounded-lg bg-blue-100 px-4 py-3 text-center font-bold  text-blue-900 outline-none ring-indigo-300 transition duration-100">
              Sale 70%
            </span>

            <h1 className="text-black-800 mb-4  text-8xl font-bold sm:text-5xl md:mb-12 md:text-6xl">
              An Industrial Take on Streetwear{" "}
            </h1>

            <p className="text-md w-44">
